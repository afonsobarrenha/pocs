# POCs - Provas de Conceito ![GitHub release](https://img.shields.io/badge/release-v2.10.0-blue.svg)
...
- [x] __1.1 - Mentalidade (Mindset) DevOps e seus benefícios (10% / 10%)__
  ...
  - [x] 1.1.3 - Explicar por que o DevOps se adequa tão bem ao atual processo de desenvolvimento de software
    - [x] Effective DevOps - chapter 3  
    - [x] Continuous Delivery - chapter 1
    - [x] Enterprise DevOps - chapter 4

  - [x] 1.1.4 - Explicar por que DevOps precisa de uma mentalidade específica para trabalhar
...
- [Effective DevOps: Building a Culture of Collaboration, Affinity, and Tooling at Scale](https://www.amazon.com.br/Effective-DevOps-Building-Collaboration-Affinity-ebook/dp/B01GGQKXOE?tag=kns00-20&ascsubtag=go_1674354623_67879846794_326760988920_aud-519888259198:dsa-19959388920_c_  )
- [Success with Enterprise DevOps](https://dit.dk/~/media/Files/Certificering/DevOps_Whitepaper.ashx?la=da)
