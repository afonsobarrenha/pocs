...
```
Effective-x   = capítulo x do livro Effective DevOps: Building a Culture of Collaboration, Affinity, and Tooling at Scale
Continuous-y  = capítulo y do livro Continuous Delivery: Reliable Software Releases through Build, Test, and Deployment
Enterprise-z  = capítulo z do livro Success with Enterprise
```
