...
```
Effective   = Effective: Building a Culture of Collaboration, Affinity, and Tooling at Scale
Continuous  = Continuous Delivery: Reliable Software Releases through Build, Test, and Deployment
Enterprise  = Success with Enterprise
```
...
|-------|----------------------------------------                                               |-----                          |-----|
| 3.5.1 | Explicar por que a automação é importante para o DevOps eficaz                        | Continuous-13,15  | [ ] |
| 3.5.2 | Explicar como usar ferramentas para facilitar DevOps em geral                         | Continuous-3,5,15  | [ ] |
| 3.5.3 | Explicar como usar ferramentas para dar suporte à mentalidade e cultura do DevOps     | Continuous-15      | [ ] |
| 3.5.4 | Explicar por que é importante que o teste de DevOps seja automatizado                 | Continuous-3       | [ ] |
| 3.5.5 | Analisar um cenário e escolher a maneira correta de automatizar um teste de aceitação | Continuous-3       | [ ] |
...
|-------|----------------------------------------                                                                                                                   |-----                      |-----|
| 4.5.1 | Analisar um cenário, explicar se e por que é importante dimensionar par acima ou para baixo nessa situação, e identificar a melhor maneira de fazer isso  | Effective-14     | [ ] |
...
|-------|----------------------------------------                                               |---- |-----|
| 5.1.1 | Explicquem que condições devem ser cumpridas antes de terminar um serviço ou produto  | c-7 | [ ] |
